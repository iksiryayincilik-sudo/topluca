...
function wy_nav(string $page): array{
    ...
    return [
        ...
        ['PAZARLAMA',[['campaigns','%','Kampanyalar',null],['banners','▧','Banner & Ana Sayfa',null],['themes','✦','Tasarım & Tema',null]]],
        ['LOJİSTİK',[['shipping','🚚','Kargo & Ankara',null]]],
        ['RAPORLAMA',[['analytics','⌁','Analiz Merkezi',$abandoned]]],
        ['SİSTEM',[['settings','⚙','Site & SEO Ayarları',null],['logs','≡','İşlem Kayıtları',null]]],
    ];
}
